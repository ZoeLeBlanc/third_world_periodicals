...
def classify_corpus(df, tfidf_model, log_model, file_name):
    """Classify each corpus using earlier trained model and save results"""
...
tfidf_model = joblib.load('../data/chap4_congo_classifier2_saved_tfidf_model.pkl') 
log_model = joblib.load('../data/chap4_congo_classifier2_saved_logit_model.pkl') 
...
scribe_filename = '../data/the_scribe_1961_1965_ao_congo2_'
scribe_df.cleaned_spacy_text = scribe_df.cleaned_spacy_text.fillna('')
classify_corpus(scribe_df, tfidf_model, log_model, scribe_filename)

bull_df = pd.read_csv('../data/Afro_Asian_Bulletin_1961_1967_volumes_processed.csv')
bull_filename = '../data/Afro_Asian_Bulletin_1961_1967_ao_congo2_'
...
arab_review_filename = '../data/Arab_Review_1960_1963_ao_congo2_'
...
ecopol_filename = '../data/Egyptian_Economic_and_Political_Review_1954_1962_ao_congo2_'
...
liberator_filename = '../data/Liberator_1961_1971_ao_congo2_'
...
freedomways_filename = '../data/Freedomways_Scraped_1961_1985_ao_congo2_'
...
arab_world_filename = '../data/arab_world_1955_1972_ao_congo2_'
arab_world_df.cleaned_spacy_text = arab_world_df.cleaned_spacy_text.fillna('')
classify_corpus(arab_world_df, tfidf_model, log_model, arab_world_filename)

afro_asian_women_df = pd.read_csv('../data/afro_asian_woman_1964_1968_volumes_processed.csv')
afro_asian_women_filename = '../data/afro_asian_women_1964_1968_ao_congo2_'
afro_asian_women_df.cleaned_spacy_text = afro_asian_women_df.cleaned_spacy_text.fillna('')
classify_corpus(afro_asian_women_df, tfidf_model, log_model, afro_asian_women_filename)

afro_asianand_world_affairs_df = pd.read_csv('../data/afro_asian_and_world_affairs_1964_1967_volumes_processed.csv')
afro_asianand_world_affairs_filename = '../data/afro_asian_and_world_affairs_1964_1967_ao_congo2_'
afro_asianand_world_affairs_df.cleaned_spacy_text = afro_asianand_world_affairs_df.cleaned_spacy_text.fillna('')
classify_corpus(afro_asianand_world_affairs_df, tfidf_model, log_model, afro_asianand_world_affairs_filename)